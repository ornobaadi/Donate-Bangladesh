document.getElementById('quota-donate-btn')
    .addEventListener('click', function (event) {
        ...
        const addMoney = getInputValue('quota-donate-amount');

        const donate = getTextValue('quota-account');
        ...
        if(addMoney <= 0){
            ...
            document.getElementById('quota-account').innerText = newDonate;
        ...
        if(addMoney > balance){
            ...
            div.innerHTML = `
                <h4 class="text-2xl px-2 font-bold">${addMoney} Taka is Aid for Injured in the Quota Movement, Bangladesh</h4>
